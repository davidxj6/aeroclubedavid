...
class AeronavesControllerTest < ActionController::TestCase
  ...
  test "should create aeronafe" do
    assert_difference('Aeronave.count') do
      post :create, aeronafe: { chassi: @aeronafe.chassi, horasVoo: @aeronafe.horasVoo, motor: @aeronafe.motor, nome: @aeronafe.nome, tamanho: @aeronafe.tamanho, tripulantes: @aeronafe.tripulantes }
    end
  ...
  test "should update aeronafe" do
    patch :update, id: @aeronafe, aeronafe: { chassi: @aeronafe.chassi, horasVoo: @aeronafe.horasVoo, motor: @aeronafe.motor, nome: @aeronafe.nome, tamanho: @aeronafe.tamanho, tripulantes: @aeronafe.tripulantes }
    assert_redirected_to aeronafe_path(assigns(:aeronafe))
  end
